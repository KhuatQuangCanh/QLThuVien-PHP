          ...
          <div class="card-body">
            ...
            <form method="post" action="{{route('admin.danhmucsach.post-form-nhap-tap',['idSach'=>$sach[0]->MaSach])}}" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input name="TenTap" type="text" class="form-control" id="exampleInputName1" placeholder="Nhập tên tập ...">
                @error('TenTap')
              ...
              <div class="form-group">
                ...
                <textarea name="NoiDungTap" class="form-control" id="exampleInputEmail3" cols="30" rows="10" placeholder="Nhập nội dung ..."></textarea>
                @error('NoiDungTap')
                <span style="color: red;">{{$message}}</span>
                @enderror
              </div>
              <div class="form-group">
                ...
                <input name="SoTrangTap" type="number" class="form-control" id="exampleInputPassword4" placeholder="Nhập số trang ...">
                @error('SoTrangTap')
                <span style="color: red;">{{$message}}</span>
                @enderror
              </div>
              <div class="form-group">
                ...
                <input name="SoLuongBS" type="number" class="form-control" id="exampleInputPassword4" placeholder="Nhập số lượng bản sao ...">
                @error('SoLuongBS')
                <span style="color: red;">{{$message}}</span>
                @enderror
              </div>
              <div class="form-group">
                <label>Ảnh tập</label>
                <input type="file" name="AnhTap" class="file-upload-default" id="upload-input">
                <div class="input-group col-xs-12">
                  <input type="text" class="form-control file-upload-info" disabled placeholder="Ảnh tập ...">
