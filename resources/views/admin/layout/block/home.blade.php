                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('assets/admin/images/faces/face2.jpg')}}" class="me-2" alt="image"> Stella
                                        Johnson
                                    </td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex mt-5 align-items-top">
                        <img src="{{asset('assets/admin/images/faces/face3.jpg')}}" class="img-sm rounded-circle me-3" alt="image">
