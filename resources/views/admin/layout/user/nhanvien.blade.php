...
<div class="card">
        ...
        @endif
        <div class="card-body">
        <a href="{{route('admin.nhanvien.get-them-nv')}}" type="button" class="btn-sm btn-info btn-fw">Thêm nhân viên</a>
        </div>
        <div class="card-body">
            <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <!--  <td>{{$item->TenTK}}</td>
                        ...
                        <td>{{$item->LoaiTK}}</td> -->
                        <td>
                        <a href="{{route('admin.nhanvien.get-edit-nv',['id'=>$item->MaTK])}}" type="button" class="btn-sm btn-info btn-fw">Sửa</a>
