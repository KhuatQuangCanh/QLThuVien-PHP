                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.order.update-status', ['orderId' => $item->MaDonDat]) }}" method="POST" class="btn-md">
                                @csrf
                                <select name="trangthai" class="btn-md" @if($item->TrangThaiDonDat == 'Đã trả') disabled @endif>
                                    ...
                                    <option value="Đã trả" @if($item->TrangThaiDonDat == 'Đã trả') selected @endif>Đã trả</option>
                                </select>
                                
                                <button type="submit" class="btn btn-primary btn-sm" @if($item->TrangThaiDonDat == 'Đã trả') disabled @endif>Cập nhật</button>
                            </form>
                        </td>
                        <td>
