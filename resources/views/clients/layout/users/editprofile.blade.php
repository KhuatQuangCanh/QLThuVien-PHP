...
@if(!Empty($profile))
<section>
    <form action="{{route('clients.user.post-edit-profile',$profile[0]->MaTK )}}" method="post"
                    ...
                    <div class="card" style="margin-top: 20px; margin-bottom: 20px; ">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $profile[0]->Fullname }}"
                                    name="Fullname" placeholder="Họ và tên ..." style="width: 100%;">
                            </div>
                            <div class="form-group">
                                <label for="exampleSelectGender">Giởi tính</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $profile[0]->SDT }}" name="SDT"
                                    placeholder="Số điện thoại ..." style="width: 100%;">
                            </div>
                            <div class="form-group">
                                <label>Ngày sinh</label>
                                <input type="date" class="form-control" value="{{ $profile[0]->Dob }}" name="Dob"
                                    placeholder="Ngày sinh ..," style="width: 100%;">
                            </div>
                    ...
                    <div class="card" style="margin-top: 20px; margin-bottom: 20px; ">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $profile[0]->TenTK }}" name="TenTK"
                                    placeholder="Tài khoản ..." style="width: 100%;" disabled>
                            </div>
                            <div class="form-group">
                                <label>Mật khẩu</label>
                                <input type="password" class="form-control" value="{{ $profile[0]->MatKhau }}"
                                    placeholder="Mật khẩu ..." style="width: 100%;" disabled>
                            </div <div class="form-group">
                            <label>Email</label>
                            <input type="text" class="form-control" value="{{ $profile[0]->Email }}" name="Email"
                                placeholder="Email ..." style="width: 100%;">
                        </div>

                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <input type="text" class="form-control" value="{{ $profile[0]->DiaChi }}" name="DiaChi"
