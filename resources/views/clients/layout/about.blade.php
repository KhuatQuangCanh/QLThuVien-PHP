        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="team-member text-center">
                    ...
                    <figure>
                        <a href="#"><img src="{{asset('assets/images/team-member2.jpg')}}" alt="post" class="member-image"></a>
                    </figure>
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="team-member text-center">
                    <figure>
                        <img src="{{asset('assets/images/team-member5.jpg')}}" alt="post" class="member-image">
                    </figure>
                    <div class="member-details text-center">
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="team-member text-center">
                    <figure>
                        <img src="{{asset('assets/images/team-member7.jpg')}}" alt="post" class="member-image">
                    </figure>
                    <div class="member-details text-center">
            ...
            <div class="col-md-3 text-center">
                ...
                <div class="team-member text-center">
                    <figure>
                        <img src="{{asset('assets/images/team-member3.jpg')}}" alt="post" class="member-image">
                    </figure>
                    <div class="member-details text-center">
                        <h4>Mrs Lora Inn</h4>
...
<section class="padding-large">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <img src="{{asset('assets/images/post-img3.jpg')}}" alt="book-authors" class="align-right">
                <p>
